...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/calendrier/calendrier.component.html":
  /*!********************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/calendrier/calendrier.component.html ***!
    \********************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCalendrierCalendrierComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppFooterFooterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<footer class=\"footer\">\n    <div class=\"container-fluid\">\n        <div class=\"row text-muted\">\n            <div class=\"col-6 text-left\">\n                <p class=\"mb-0\">\n                    <a href=\"index-2.html\" class=\"text-muted\"><strong>Farmavans - gestion interne</strong></a> &copy;\n                </p>\n            </div>\n            <div class=\"col-6 text-right\">\n                powered by <strong>< ybh /></strong> \n            </div>\n        </div>\n    </div>\n</footer>";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _calendrier_calendrier_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./calendrier/calendrier.component */
    ...
    var routes = [{
      ...
      path: 'calendrier',
      component: _calendrier_calendrier_component__WEBPACK_IMPORTED_MODULE_24__["CalendrierComponent"],
      canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]]
    }, {
      path: 'login',
  ...
  function srcAppAppComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".msg{\r\n    color:rgb(220, 53, 69)\r\n}\r\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbInNyYy9hcHAvYXBwLmNvbXBvbmVudC5jc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7SUFDSTtBQUNKIiwiZmlsZSI6InNyYy9hcHAvYXBwLmNvbXBvbmVudC5jc3MiLCJzb3VyY2VzQ29udGVudCI6WyIubXNne1xyXG4gICAgY29sb3I6cmdiKDIyMCwgNTMsIDY5KVxyXG59Il19 */";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _calendrier_calendrier_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(
    /*! ./calendrier/calendrier.component */
    "./src/app/calendrier/calendrier.component.ts");
    /* harmony import */
  ...
  /***/
  function srcAppCalendrierCalendrierComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCalendrierCalendrierComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CalendrierComponent = /*#__PURE__*/function () {
      function CalendrierComponent(modal, taskserv) {
        _classCallCheck(this, CalendrierComponent);

        this.modal = modal;
        this.taskserv = taskserv;
        this.view = angular_calendar__WEBPACK_IMPORTED_MODULE_4__["CalendarView"].Week;
      ...
      _createClass(CalendrierComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.taskserv.getAll().subscribe(function (res) {
            _this7.loading = true;
            var ev = [];
    ...
    CalendrierComponent.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('modalContent', {
      "static": true
    })], CalendrierComponent.prototype, "modalContent", void 0);
    CalendrierComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/calendrier/calendrier.component.html"))["default"],
      animations: [angular_calendar__WEBPACK_IMPORTED_MODULE_4__["collapseAnimation"]],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./calendrier.component.css */
      "./src/app/calendrier/calendrier.component.css"))["default"]]
    })], CalendrierComponent);
    /***/
  },
        ...
        value: function ngOnInit() {
          ...
          this.cliService.getAll('pharmacie').subscribe(function (res) {
            if (res) {
              ...
              _this11.trigger.next();
            }
          }, function (err) {
            return _this11.listgr = [];
          });
          this.userv.getAllDeleges().subscribe(function (res) {
            _this11.deleges = res;
          });
      ...
      _createClass(CommandesHistoriqueComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userv.getCurrentUser().subscribe(function (user) {
            if (user) {
              ...
              _this14.comserv.getAll().subscribe(function (res) {
                if (user.role === "admin") {
                  _this14.commandes = res;
                } else {
                  _this14.commandes = res.filter(function (x) {
                    return x.emetteur.email === user.email;
                  });
                }

                _this14.trigger.next();
              });
            }
          });
        }
        ...
        value: function loadInvoice(c) {
          ...
          this.comserv.getProduitsOfCommande(c.id).subscribe(function (lignec) {
            _this15.detailsCommande = lignec;
          });
        }
      }, {
        key: "deleteInvoice",
        ...
        value: function ngOnInit() {
          ...
          if (this.userservice.getLoggedOn()) {
            this.userservice.getCurrentUser().subscribe(function (user) {
              _this16.cliserv.getAll('pharmacie').subscribe(function (ph) {
                _this16.cliserv.getAll('grossiste').subscribe(function (g) {
                  _this16.prodserv.getAll().subscribe(function (p) {
                    _this16.produits = p;
                    _this16.grossistes = g;

                    _this16.packserv.getAll().subscribe(function (packs) {
                      _this16.packs = packs;

                      if (user) {
                        if (user.role == 'admin') {
                          _this16.clients = ph.concat(g);
                        } else {
                          var pharmacie,
                              grossistes = null;
                          pharmacie = ph.filter(function (x) {
                            return x.delegue.email === _this16.userservice.getLoggedOn().email;
                          });

                          if (pharmacie) {
                            _this16.clients = _this16.clients.concat(pharmacie);
                          }
                          ...
                          if (grossistes) {
                            _this16.clients = _this16.clients.concat(grossistes);
                          }
                        }
                      }
                    });
        ...
        value: function submit() {
          ...
          if (this.products() && this.commandeForm.valid) {
            ...
            this.comserv.add(this.commandeToAdd, this.products().value).subscribe(function (res) {
              if (_this18.selectedPack) {
                _this18.packserv.updatePackSoldCount(_this18.selectedPack.id).subscribe(function (res) {
                  window.location.reload();
                });
        ...
        value: function estimationTotal() {
          ...
          if (this.isPanache && this.selectedPack.type_pack === 'panache') {
            ...
            this.commandeForm.value.products.forEach(function (element) {
              _this19.totalQte += element.quantite ? Number(element.quantite) : 0;

              var produitu = _this19.produits.filter(function (x) {
            ...
            this.commandeForm.value.products.forEach(function (element) {
              _this19.totalQte += element.quantite ? Number(element.quantite) : 0;
              _this19.totalReduction += element.reduction ? Number(element.reduction) : 0;
              nbprod++;
              ...
              var nprixu = Number(produitu.prix - produitu.prix * (element.reduction / 100));
              _this19.totalTTC += Number(nprixu * element.quantite);
            });
        ...
        value: function loadPackage() {
          ...
          if (this.targetClient.type_client == 'pharmacie') {
            this.packserv.getProdPacks(this.selectedPack.id).subscribe(function (data) {
              if (data && _this20.selectedPack.type_pack == "normal") {
                _this20.isPanache = false;
                _this20.products().controls = [];
                data.forEach(function (p) {
                  _this20.addProductWithValue(p.produits_packs[0], p.quantite, 0, Number(p.produits_packs[0].prix * p.quantite));
                });
              } else if (_this20.selectedPack.type_pack === 'panache') {
                _this20.isPanache = true;
                _this20.products().controls = [];
                _this20.commandeForm.value.products = [];
              }

              _this20.estimationTotal(); //this.totalTTC = this.selectedPack.prix_total
    ...
    var ContactsComponent = /*#__PURE__*/function () {
      ...
      _createClass(ContactsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setTimeout(function () {
            _this21.contserv.getAll().subscribe(function (c) {
              _this21.contacts = c;

              if (c.length > 0) {
                _this21.contactForDetails = c[0];
        ...
        value: function ngOnInit() {
          ...
          this.statserv.getAll().subscribe(function (res) {
            ...
            for (var index = 0; index < res.bymonth.length; index++) {
              _this24.lineChartLabels.push(res.bymonth[index].month);
            ...
            _this24.lineChartData = lineTab;
            var tabBar = [];

            for (var _index = 0; _index < res.bydeleg.length; _index++) {
              console.log(res.bydeleg[_index]);

              _this24.barChartLabels.push(res.bydeleg[_index].user);
    ...
    var EvaluationsComponent = /*#__PURE__*/function () {
      ...
      _createClass(EvaluationsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setTimeout(function () {
            _this25.userv.getAllDeleges().subscribe(function (res) {
              _this25.users = res;

              _this25.trigger.next();

              _this25.loading = false;
              _this25.loadUsers = false;
            });
          }, 3000);
        } // events
        ...
        key: "chartClicked",
        value: function chartClicked(_ref2) {
        ...
        key: "chartHovered",
        value: function chartHovered(_ref3) {
        ...
        value: function showDetails(c) {
          ...
          this.evalserv.getEvalsOfdeleg(c.id).subscribe(function (res) {
            ...
            if (res.length > 0) {
              ...
              _this28.lineChartData = [{
                data: marks,
                label: 'Note',
                fill: true
              }];
              _this28.lineChartLabels = labels;
              _this28.noteDelegeTotal = n / res.length;
            }

            _this28.evaluations = res;
            ...
            try {
              this.userservice.login(this.email, this.password).subscribe(function (res) {
                if (res && res.auth) {
                  ...
                  _this29.router.navigate(['/dashboard']);
                } else _this29.errors = true;
              }, function (err) {
                _this29.errors = true;
              });
            } catch (e) {
        ...
        value: function ngOnInit() {
          ...
          if (this.userv.getCurrentUser()) {
            this.userv.getCurrentUser().subscribe(function (res) {
              _this30.user.nom = res.nom;
              _this30.user.prenom = res.prenom;
              _this30.user.role = res.role;
            });
          }
        }
      }, {
    ...
    var PacksComponent = /*#__PURE__*/function () {
      ...
      _createClass(PacksComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.produitserv.getAll().subscribe(function (resl) {
            _this32.produits = resl;

            _this32.packserv.getAll().subscribe(function (packs) {
              _this32.userv.getCurrentUser().subscribe(function (u) {
                _this32.user = u;
              });

              _this32.listPacks = packs;
              _this32.initialLoder = false;

              _this32.trigger.next();
            });
          });
        }
      }, {
          ...
          try {
            var _loop = function _loop() {
              ...
              if (element.prixUnitaire == undefined && element.gratuit == false) {
                element.prixUnitaire = _this34.produits.filter(function (x) {
                  return x.id === element.produit;
                })[0].prix;
              }

              if (element.prixUnitaire >= 0 && element.quantite >= 0) {
                _this34.packToadd.prix_total += Number(element.prixUnitaire) * Number(element.quantite);
              }
            };
        ...
        value: function showPackDetails(pack) {
          ...
          this.packserv.getProdPacks(pack.id).subscribe(function (res) {
            _this35.selectedPack = pack;
            _this35.PPOfselectedPack = res;
          });
        }
      }, {
        key: "deletePack",
        value: function deletePack() {
          ...
          this.packserv["delete"](this.selectedPackForDelete.id).subscribe(function () {
            _this36.selectedPackForDelete = null;
            window.location.reload();
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          if (this.userservice.getLoggedOn()) {
            this.userservice.getCurrentUser().subscribe(function (user) {
              ...
              console.log(_this39.group(_this39.veilles, function (v) {
                return v.produitCible.libelle;
              }));
            });
          }
        }
      ...
      _createClass(ClientService, [{
        ...
        value: function add(client) {
          ...
          if (client && connnectedUser) {
            ...
            return this.http.post('/api/addClient', {
              client: client
            }, options);
          }
        ...
        value: function edit(client) {
          ...
          if (client && connnectedUser) {
            ...
            return this.http.post('/api/editClient', {
              client: client
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteClient', {
              id: id
            }, options);
          }
      ...
      _createClass(CommandeService, [{
        ...
        value: function getProduitsOfCommande(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/getCommandesProducts', {
              commande: id
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteCommande', {
              commandeId: id
            }, options);
          }
      ...
      _createClass(CommentService, [{
        ...
        value: function edit(comm) {
          ...
          if (comm && connnectedUser) {
            ...
            return this.http.post('/api/editComment', {
              comment: comm
            }, options);
          }
        ...
        value: function getCommentsOfTask(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getCommentsOfTask', {
              task: id
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteComment', {
              comment: id
            }, options);
          }
      ...
      _createClass(ContactService, [{
        ...
        value: function add(reun) {
          ...
          if (reun && connnectedUser) {
            ...
            return this.http.post('/api/addContact', {
              contact: reun,
        ...
        value: function update(contact) {
          ...
          if (contact && connnectedUser) {
            ...
            return this.http.post('/api/updateContact', {
              contact: contact
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteContact', {
              id: id
            }, options);
          }
      ...
      _createClass(EvalService, [{
        ...
        value: function getEvalsOfdeleg(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getEvalsOfdeleg', {
              id: id
            }, options);
          }
        ...
        value: function add(evaluation, email) {
          ...
          if (eval && connnectedUser) {
            ...
            return this.http.post('/api/addEval', {
              eval: evaluation,
              email: email
            }, options);
          }
        ...
        value: function update(evaluation) {
          ...
          if (evaluation && connnectedUser) {
            ...
            return this.http.post('/api/editEval', {
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteEval', {
              id: id
            }, options);
          }
      ...
      _createClass(NotificationService, [{
        ...
        value: function get(email) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getNotificationsOfUser', {
              email: email
            }, options);
          }
        ...
        value: function add(content, title, targetsId, sender, taskId) {
          ...
          if (content && title && targetsId && sender && taskId && connnectedUser) {
            ...
            return this.http.post('/api/addNotif', {
              notif: {
                content: content,
                title: title
              },
        ...
        value: function updateSeen(email) {
          ...
          if (email && connnectedUser) {
            ...
            return this.http.post('/api/updateNotif', {
              email: email
            }, options);
          }
        ...
        value: function getAll() {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getAllTasks', {
              email: connnectedUser.email
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteNotif', {
              id: id
            }, options);
          }
      ...
      _createClass(PackService, [{
        ...
        value: function add(pack, produits) {
          ...
          if (pack && connnectedUser) {
            ...
            return this.http.post('/api/addPack', {
              pack: pack,
              produits: produits
            }, options);
          }
        ...
        value: function edit(product) {
          ...
          if (product && connnectedUser) {
            ...
            return this.http.post('/api/editProduct', {
              produit: product
            }, options);
          }
        ...
        value: function getProdPacks(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getProdPacks', {
              pack: id
            }, options);
          }
        ...
        value: function updatePackSoldCount(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/incrementPackSold', {
              pack: id
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deletePack', {
              packId: id
            }, options);
          }
      ...
      _createClass(ProductService, [{
        ...
        value: function addProduct(product) {
          ...
          if (product && connnectedUser) {
            ...
            return this.http.post('/api/addProduct', {
              produit: product
            }, options);
          }
      ...
      _createClass(RapportService, [{
        ...
        value: function getRdOfRapport(rapport) {
          ...
          if (rapport && connnectedUser) {
            ...
            return this.http.post('/api/getRDOfrapport', {
              report: rapport
            }, options);
          }
        ...
        value: function add(rapport, rapport_data) {
          ...
          if (rapport && rapport_data && connnectedUser) {
            ...
            return this.http.post('/api/addRapport', {
              rapport: rapport,
        ...
        value: function update(rapport, rapport_data, deletableRows) {
          ...
          if (rapport && rapport_data && connnectedUser) {
            ...
            return this.http.post('/api/editRapport', {
              rapport: rapport,
              rapport_data: rapport_data,
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteRapport', {
              id: id
            }, options);
          }
      ...
      _createClass(ReunionService, [{
        ...
        value: function add(reun) {
          ...
          if (reun && connnectedUser) {
            ...
            return this.http.post('/api/addReun', {
              reunions: reun,
              email: connnectedUser.email
            }, options);
          }
        ...
        value: function update(reunion) {
          ...
          if (reunion && connnectedUser) {
            ...
            return this.http.post('/api/updateReun', {
              reun: reunion
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteReun', {
              id: id
            }, options);
          }
      ...
      _createClass(TaskService, [{
        ...
        value: function get(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getTask', {
              task: id
            }, options);
          }
        ...
        value: function add(task, users) {
          ...
          if (task && connnectedUser) {
            ...
            return this.http.post('/api/addTask', {
              task: task,
              users: users
            }, options);
          }
        ...
        value: function getUTOFtask(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getUTOfTask', {
              task: id
            }, options);
          }
        ...
        value: function getTasksOfUser(id) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/getTasksOfUser', {
              user: id
            }, options);
          }
        ...
        value: function updateTaskStatus(id, status) {
          ...
          if (connnectedUser) {
            ...
            return this.http.post('/api/updateTaskstatus', {
              id: id,
              state: status
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteTask', {
              id: id
            }, options);
          }
      ...
      _createClass(UserService, [{
        ...
        value: function updateUserPW(pw) {
          ...
          if (pw && connnectedUser) {
            ...
            return this.http.post('/api/update-pw', {
              password: pw,
              email: connnectedUser.email
            }, options);
          }
      ...
      _createClass(VehiculeService, [{
        ...
        value: function getUserVehicle(targetEmail) {
          ...
          if (targetEmail && connnectedUser) {
            ...
            return this.http.post('/api/getUserCars', {
              email: targetEmail
            }, options);
          }
        ...
        value: function addVehicle(vehicule) {
          ...
          if (vehicule && connnectedUser) {
            ...
            return this.http.post('/api/addVehicle', {
              vehicule: vehicule
            }, options);
          }
      ...
      _createClass(VeilleService, [{
        ...
        value: function getVeillesOfProduct(idp) {
          ...
          if (idp && connnectedUser) {
            ...
            return this.http.post('/api/getVeillesOfProduct', {
              id: idp
            }, options);
          }
        ...
        value: function _delete(id) {
          ...
          if (id && connnectedUser) {
            ...
            return this.http.post('/api/deleteVeille', {
              id: id
            }, options);
          }
    ...
    var TaskDiscussionComponent = /*#__PURE__*/function () {
      ...
      _createClass(TaskDiscussionComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setTimeout(function () {
            _this51.activatedRoute.paramMap.subscribe(function (x) {
              _this51.taskserv.get(x.get('id')).subscribe(function (task) {
                _this51.userv.getCurrentUser().subscribe(function (x) {
                  return _this51.connectedUser = x;
                });

                if (task) {
                  _this51.taskserv.getUTOFtask(Number(x.get('id'))).subscribe(function (todo) {
                    if (todo) {
                      _this51.targetTask = task;
                      _this51.todos = todo;

                      _this51.commserv.getCommentsOfTask(_this51.targetTask.id).subscribe(function (comments) {
                        _this51.commentsList = comments;
                        _this51.loading = false;
                      });
                    }
                  });
                } else _this51.router.navigateByUrl('/tasks');
              });
            });
          }, 5000);
        }
          ...
          this.commserv.add(this.text, this.targetTask.id).subscribe(function (comment) {
            setTimeout(function () {
              if (comment) {
                ...
                _this52.todos.forEach(function (t) {
                  if (t.task_users[0].id != _this52.connectedUser.id) {
                    targetUsers.push(t.task_users[0].id);
                  }
                });

                if (_this52.connectedUser.role != 'admin') {
                  targetUsers.push(1);
                }

                if (targetUsers.length > 0) {
                  _this52.notifserv.add(comment.comment.content, "nouveau message", targetUsers, _this52.connectedUser.email, _this52.targetTask.id).subscribe(function (r) {
                    _this52.commentsList.push(comment.comment);
        ...
        value: function updateTaskStatus() {
          ...
          this.taskserv.updateTaskStatus(this.targetTask.id, true).subscribe(function (x) {
            _this53.router.navigateByUrl('/tasks');
          });
        }
      }, {
        key: "deleteMessage",
      ...
      _createClass(TaskElementComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userserv.getCurrentUser().subscribe(function (u) {
            if (u) {
              _this55.connectedUser = u;

              _this55.taskserv.getUTOFtask(_this55.task.id).subscribe(function (res) {
                _this55.UToftask = res;
              });
            }
          });
        }
        ...
        value: function ngOnInit() {
          ...
          this.userv.getCurrentUser().subscribe(function (user) {
            if (user) {
              ...
              _this56.connectedUser = user;

              if (_this56.connectedUser.role === 'admin' || _this56.connectedUser.role === 'superviseur') {
                setTimeout(function () {
                  _this56.taskserv.getAll().subscribe(function (task) {
                    _this56.userv.getAllDeleges().subscribe(function (d) {
                      _this56.deleges = d;
                      _this56.tasks = task;
                ...
                setTimeout(function () {
                  _this56.taskserv.getTasksOfUser(user.id).subscribe(function (tasks) {
                    _this56.loading = false;
                    _this56.tasks = tasks;
                  });
                }, 5000);
    ...
    var TopbarComponent = /*#__PURE__*/function () {
      ...
      _createClass(TopbarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.userv.getCurrentUser()) {
            this.userv.getCurrentUser().subscribe(function (res) {
              _this58.user.nom = res.nom;
              _this58.user.prenom = res.prenom;
              _this58.user.imageUrl = res.imageUrl;
              _this58.user.email = res.email;

              _this58.loadMessages();
            });
          }
        }
      }, {
        ...
        value: function redirectToChat(m) {
          ...
          this.nserv["delete"](m.id).subscribe(function (res) {
            _this61.router.navigateByUrl('discussion/' + m.subject.id);
          });
        }
      }]);
